...
Source:		http://yatebts.com/%{name}-%{version}-1.tar.gz
Group:		Applications/Communications
BuildRoot:	%{_tmppath}/%{name}-%{version}-%{release}-root
URL:		http://yatebts.com/
BuildRequires:	gcc-c++
BuildRequires:	yate-devel >= 5.5.0
Requires:	yate = 5.5.0
Requires:	yate-gsm = 5.5.0
